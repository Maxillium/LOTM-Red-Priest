                ...
                for (Entity entity : Objects.requireNonNull(loc.getWorld()).getNearbyEntities(loc, 10, 10, 10)) {
                    if (random == 0) {
                        ...
                        if (entity instanceof LivingEntity) {
                            ...
                            if(entity instanceof Player && entity !=p) {
                                ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 200, 1, true, true));
                                if(((Player) entity).hasPotionEffect(PotionEffectType.WITHER) && pathway.getSequence().getCurrentSequence() >= 4)
                                {
                                    ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 200, 2, true, true));
                                }
                            }
                        }
                    }
                        ...
                        if (entity instanceof LivingEntity) {
                            ...
                            if(entity instanceof Player && entity !=p) {
                                ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 200, 1, true, true));
                        ...
                        if (entity instanceof LivingEntity) {
                            ...
                            if(entity instanceof Player && entity !=p) {
                                ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.WITHER, 200, 1, true, true));
                                if(((Player) entity).hasPotionEffect(PotionEffectType.SLOW) && pathway.getSequence().getCurrentSequence() >= 4 )
                                {
                                    ((LivingEntity) entity).addPotionEffect(new PotionEffect(PotionEffectType.WITHER, 200, 2, true, true));
                                }
                            }
                        }
                    }
