...
public class Flame_transform extends Ability {
    ...
    public void useAbility() {
        ...
        new BukkitRunnable() {
            ...
            @Override
            public void run() {
                p.getWorld().spawnParticle(Particle.SMALL_FLAME, p.getEyeLocation(), 100, 1.1, 1.1, 1.1, 0);
    ...
    public ItemStack getItem() {
        return Red_PriestItems.createItem(Material.CAMPFIRE, "Fire Transformation", "420/s", identifier, 4, Objects.requireNonNull(Bukkit.getPlayer(pathway.getUuid())).getName());
    }
}